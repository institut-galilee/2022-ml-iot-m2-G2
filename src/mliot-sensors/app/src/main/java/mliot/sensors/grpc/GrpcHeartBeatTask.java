...
import mliot.sensors.generated.HeartBeatMessage;
import mliot.sensors.generated.SinkServiceGrpc;
import mliot.sensors.util.Prefs;

public class GrpcHeartBeatTask extends AsyncTask<Float, Void, Void> {
